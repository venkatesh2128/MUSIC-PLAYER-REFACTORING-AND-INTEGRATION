...
import com.sismics.music.rest.resource.strategies.search.LastFmSearchStrategy;
import com.sismics.music.rest.resource.strategies.search.SpotifySearchStrategy;
...
public class SearchResource extends BaseResource {
        ...
        public Response get(
                ...
                List<AlbumDto> albumList = albumDao
                                .findByCriteria(new AlbumCriteria().setUserId(principal.getId()).setNameLike(query));
        ...
        public Response searchLastFm(@QueryParam("query") String query) {
                return new LastFmSearchStrategy().search(query);
        }

        @GET
        @Path("spotify")
        @Produces(MediaType.APPLICATION_JSON)
        public Response searchSpotify(@QueryParam("query") String query) {
                return new SpotifySearchStrategy().search(query);
        }
}
