...
angular.module("music").controller("Navigation", function ($rootScope, $http, $scope, User, $state, Playlist, NamedPlaylist, Websocket) {
  ...
  $scope.commandLastFm = function () {
    console.log($scope.query);
    $rootScope.searchLastFm($scope.query);
  };

  $scope.commandSpotify = function () {
    console.log($scope.query);
    $rootScope.searchSpotify($scope.query);
    // TODO give command to search spotify
  };
});
