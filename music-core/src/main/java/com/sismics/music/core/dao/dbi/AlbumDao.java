...
public class AlbumDao extends BaseDao<AlbumDto, AlbumCriteria> {
    ...
    public QueryParam getQueryParam(AlbumCriteria criteria, FilterCriteria filterCriteria) {
        ...
        StringBuilder sb = new StringBuilder("select a.id as id, a.name as c0, a.albumart as albumArt, a.artist_id as artistId, ar.name as artistName, a.updatedate as c1, a.user_id as userId,");
...
//                "  from t_album a" +
              return   handle.createQuery("select a.id, a.directory_id, a.artist_id, a.name, a.albumart, a.updatedate, a.createdate, a.deletedate, a.location ,a.user_id" +
                                "  from t_album a" +
