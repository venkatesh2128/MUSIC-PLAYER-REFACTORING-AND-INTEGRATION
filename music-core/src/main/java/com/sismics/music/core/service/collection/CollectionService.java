...
public class CollectionService extends AbstractScheduledService {
    ...
    public void readTrackMetadata(Directory rootDirectory, Path file, Track track) throws Exception {
        ...
        if (album == null || !(album.getUserId().equals(StringUtils.abbreviate(tag.getFirst(FieldKey.CUSTOM1), 0, 1000)))) {
            // Import album art
            ...
            album.setUserId(StringUtils.abbreviate(tag.getFirst(FieldKey.CUSTOM1), 0, 1000));
